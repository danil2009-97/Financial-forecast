...
ticker = "RUB=X"
df = pdr.get_data_yahoo(ticker, start="2015-01-01", end="2021-01-28")


# Drop volume on commodities because it is essentially NaNs and tensorflow gets sad when you give it nans
...
df.to_csv(r'/home/ubuntu/Desktop/RUB.csv')

df = pd.read_csv('/home/ubuntu/Desktop/RUB.csv', sep=',', parse_dates=[0], index_col=0, dayfirst=False)
idx = pd.date_range('2015-01-01', '2021-01-28')
...
pd.read_csv('/home/ubuntu/Desktop/RUB.csv') 
...
def load_data(ticker, n_steps=50, scale=True, shuffle=True, lookup_step=1, split_by_date=True,
    ...
    if isinstance(ticker, str):
        ...
        df = pd.read_csv('/home/ubuntu/Desktop/test.csv') 
...
# lets try a GRU model at some point and see if it gives a different result
import os
import time
...
TEST_SIZE = 0.2
# features to use
FEATURE_COLUMNS = ["Adj Close", "Open", "High", "Low", "MA_20", "EMA_20","BollingerB_20", "Bollinger%b_20", "MACD_12_26", "MACDsign_12_26", "MACDdiff_12_26"]
# date now
...
#### Ideally we'd figure out how to make it automatically stop once validation loss stops improving
